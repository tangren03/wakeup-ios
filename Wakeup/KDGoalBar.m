...
-(void)setup {
    ...
    percentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 160, 160)];
//    [percentLabel setFont:[UIFont systemFontOfSize:75.0]];
    percentLabel.font = [UIFont fontWithName:@"Roboto-Thin" size:75.0];
